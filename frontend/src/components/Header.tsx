...
export const Header = () => {
	...
	return (
		<div className="sticky top-0 z-20 bg-transparent  flex justify-between items-center h-10">
			<div>
				<img
					onClick={() => navigate("/")}
					src={logo}
			...
			{dropDownIsOpen && (
				...
				>
					<div className="py-1" role="none">
						<a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-300" role="menuitem">
							Profile
						</a>
						<a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-300" role="menuitem">
							Settings
