...
export default function EncyclopediaDetailsCard({ selectedPlant }: EncyclopediaDetailsCardProps) {
	...
	useEffect(() => {
		const fetchPlantDetails = async () => {
			...
			try {
				const response = await fetchAPI(`/plants/details/${selectedPlant.id}`, { method: "GET" });
				if (!response.ok) {
